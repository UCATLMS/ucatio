...
const status = await xChain.getTxStatus("tRqTrrdYZBumtcQMRz48fm2PN9esTnZFqA9nKM5YPfEmwjp4Q")
console.log("Transaction status:", status)

const balances = await xChain.getAllBalances("X-avax15sele9k4csjlurf55qrqd340ne9ucrgheq0ny9")
