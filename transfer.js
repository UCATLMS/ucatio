...
const receiver = "X-avax1ptaxhes06934cdgzq8af0s7uverlfn9jg7tzmy" // Pathway test receiver address
...
const unsignedTx = await chain.buildBaseTx(
  ...
  binTools.stringToBuffer("UCAT Pathway") // memo, totally optional
)
...
console.log("----------------------------------------------------------------")
console.log(`Visit https://explorer.avax.network/tx/${txID} to see transaction details`)
console.log("----------------------------------------------------------------")
