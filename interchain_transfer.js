...
setTimeout(async function() {
  ...
  console.log("----------------------------------------------------------------")
  console.log(`Visit https://cchain.explorer.avax.network/address/${ethAddr} for balance details`)
  console.log("----------------------------------------------------------------")
}, 3000)
...
// Sign and send the transaction
  ...
  console.log(` - https://explorer.avax.network/tx/${exportTxID}`)
...
console.log(` - https://explorer.avax.network/tx/${importTX}`)
